    ...
    <div class="card-body p-9">
        <div class="row">
            ...
            <div class="col-6">
                ...
                <div class="row mb-7">
                    <label class="col-lg-5 fw-semibold text-muted">Pedido submetido a:</label>
                    <div class="col-lg-7">
                ...
                <div class="row mb-7">
                    <label class="col-lg-5 fw-semibold text-muted">Pedido aceite a:</label>
                    <div class="col-lg-7">
                        <span class="fw-bold fs-6 text-gray-800"><?php echo (new DateTime($patient_info_data["data_registo"]))->format("d/m/Y - H:i") . "h"; ?></span>
                    </div>
                </div>
