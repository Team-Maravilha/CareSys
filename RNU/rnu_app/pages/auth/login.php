...
<body id="kt_body" class="app-blank">
    ...
    <div class="d-flex flex-column flex-root" id="kt_app_root">
        ...
        <div class="d-flex flex-column flex-lg-row flex-column-fluid">
                    ...
                    <div class="w-lg-500px p-10">
                        ...
                        <form class="form w-100 text-center" novalidate="novalidate" id="login-form">
                            ...
                            <a class="mb-0 mb-lg-12">
                                <img alt="Logo" src="<?php echo $link_home ?>/assets/media/uploads/rnu/logo_rnu.png" class="mb-20" style="height: 110px!important;" />
                            </a>
                            <!--end::Logo-->
            ...
            <!--end::Body-->
            <!--begin::Aside-->
            <div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2" style="background-image: url(<?php echo $link_home ?>/assets/media/uploads/rnu/background.svg)">
                <!--begin::Content-->
                <div class="d-flex flex-column flex-center py-7 py-lg-15 px-5 px-md-15 w-100">
                    <!--begin::Image-->
                    <img class="d-none d-lg-block mx-auto w-75 w-md-75" src="<?php echo $link_home ?>/assets/media/uploads/rnu/image_login.png" alt="" />
                    <!--end::Image-->
                </div>
                <!--end::Content-->
            </div>
