        ...
        case "POST":
            ...
            switch ($_POST["action"]) {
                case "login":
                    ...
                    if ($email === "admin@sclinico.pt" && $password === "admin") {
                        $default_avatar = "/assets/media/avatar/blank.png";
                        $_SESSION["username"] = "admin sclinico";
                        $_SESSION["email"] = "admin@sclinico.pt";
                        $_SESSION["hashed_id"] = "3c5d4480-7e4c-11ee-93fb-66962a7e520d";
                        $_SESSION["name"] = "Admin SCLINICO";
                        ...
                        exit();
                    } else if ($email === "medico@sclinico.pt" && $password === "medico") {
                        $default_avatar = "/assets/media/avatar/blank.png";
                        $_SESSION["username"] = "medico sclinico";
                        $_SESSION["email"] = "medico@sclinico.pt";
                        $_SESSION["hashed_id"] = "074811ec-7e5d-11ee-93fb-66962a7e520d";
                        $_SESSION["name"] = "Médico SCLINICO";
