<div class="card mb-5 mb-xl-10" id="kt_profile_details_view">
    <div class="card-header cursor-pointer">
        <div class="card-title m-0">
            <h3 class="fw-bold m-0">Medicação Especial</h3>
        </div>
    </div>
    ...
    <div class="card-body">
        <div class="d-flex flex-column flex-md-row align-items-center justify-content-md-between flex-wrap mb-5 gap-4">
            ...
            <div class="d-flex flex-column flex-sm-row align-items-center justify-content-md-end gap-3">
                ...
                <button type="button" class="btn btn-light-primary d-flex align-items-center lh-1" data-bs-toggle="modal" data-bs-target="#modal-add-special-medication">
...
<div class="modal fade" id="modal-add-special-medication" tabindex="-1" aria-modal="true" role="dialog">
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            <div class="modal-header" id="modal-add-special-medication-header">
                <h2 class="fw-bold">Adicionar Medicação Especial</h2>
            ...
            <div class="modal-body mx-5 mx-xl-15 my-7">
                <form id="modal-add-special-medication-form" class="form" action="#">
                    <div class="d-flex flex-column me-n7 pe-7" id="modal-add-special-medication-form-scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#modal-add-special-medication-header" data-kt-scroll-wrappers="#modal-add-special-medication-form-scroll" data-kt-scroll-offset="350px" style="max-height: 91px;">
                        <div class="row g-6">

                            <div class="col-12">
                                <div class="fv-row">
                                    <label for="modal-add-special-medication-form-motivo" class="required fw-semibold fs-6 mb-2">Motivo</label>
                                    <input type="text" name="motivo" id="modal-add-special-medication-form-motivo" class="form-control form-control-solid mb-3 mb-lg-0" value="" placeholder="Motivo da Medicação Especial">
                                </div>
                            </div>
    ...
    var datatableServerSide = (function() {
        ...
        var initDatatable = () => {
            dt = $("#datatable_special_medication").DataTable({
                ...
                stateSave: false,
                ajax: {
                    url: "http://localhost:4000/api/patients/patient/special_medication/<?php echo $hashed_id ?>",
                    type: "GET",
                },
                columns: [{
                        data: "motivo"
                    ...
                    },
                    {
                        ...
                        render: (data, type, row) => {
                            ...
                            <div class="d-flex justify-content-end flex-shrink-0 me-6">
                                <button type="button" class="btn btn-icon btn-sm btn-light-danger d-flex align-items-center lh-1" data-element-id="${row.id_medicacao_especial}" data-element-action="delete">
        ...
        var handleAddEmergencyContact = () => {
            const modal = document.querySelector("#modal-add-special-medication");
            const form = document.querySelector("#modal-add-special-medication-form");
                ...
                if (validator) {
                    validator.validate().then((status) => {
                        if (status === "Valid") {
                            ...
                            fetch("http://localhost:4000/api/patients/patient/special_medication/add", options)
                                    ...
                                    if (data.status) {
                                        Swal.fire({
                                            ...
                                            if (result.isConfirmed) {
                                                $("#modal-add-special-medication").modal("hide");
                                                dt.ajax.reload()
            ...
            $("#datatable_special_medication").on("click", "[data-element-action='delete']", function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        fetch(`http://localhost:4000/api/patients/patient/special_medication/delete/${id}`, options)
                            .then((response) => {
                                response.text().then((json) => {
                                    ...
                                    if (response.status === 200) {
                                        ...
                                        toastr.success('Medicação Especial eliminada com sucesso!') // show response from the php script.
                                        dt.ajax.reload()
