										...
										<div class="card card-flush h-xl-100">
											...
											<div class="card-header rounded bgi-no-repeat bgi-size-cover bgi-position-y-top bgi-position-x-center align-items-start h-250px" style="background-image:url('<?php echo $link_home ?>assets/media/svg/shapes/abstract-2.svg')" data-bs-theme="light">
												...
												<h3 class="card-title align-items-start flex-column text-green pt-15">
													<span class="fw-bold fs-2x mb-3 text-green">Olá, Médico SCLINICO</span>
										...
										<div class="card h-lg-100">
											<div class="card-body d-flex justify-content-between align-items-start flex-column">
												...
												<div class="d-flex flex-column my-7">
													<span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2"><?php echo $variavel1 = rand(40, 150); ?></span>
													<div class="m-0">
									...
									<div class="col-sm-6 col-xl-3 mb-xl-10">
										<div class="card h-lg-100">
											<div class="card-body d-flex justify-content-between align-items-start flex-column">
												...
												<div class="d-flex flex-column my-7">
													<span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2"><?php echo $variavel2 = rand(40, 150); ?></span>
													<div class="m-0">
									...
									<div class="col-sm-6 col-xl-3 mb-xl-10">
										<div class="card h-lg-100">
											<div class="card-body d-flex justify-content-between align-items-start flex-column">
												...
												<div class="d-flex flex-column my-7">
													<span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2"><?php echo $variavel3 = rand(25, 50); ?></span>
													<div class="m-0">
									...
									<div class="col-sm-6 col-xl-3 mb-xl-10">
										<div class="card h-lg-100">
											<div class="card-body d-flex justify-content-between align-items-start flex-column">
												...
												<div class="d-flex flex-column my-7">
													<span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2"><?php echo $variavel4 = rand(50, 200); ?></span>
													<div class="m-0">
