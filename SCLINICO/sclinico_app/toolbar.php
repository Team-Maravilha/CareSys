        ...
        <div class="d-flex flex-column flex-row-fluid">
            ...
            <div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-4 gap-lg-10 pt-6 pb-18 py-lg-13">
                ...
                <div class="page-title d-flex align-items-center me-3">
                    ...
                    <!--begin::Title-->
                    <h1 class="page-heading d-flex text-white fw-bolder fs-2 flex-column justify-content-center my-0"><?php echo isset($page_name) ? $page_name : "CareSys | SCLINICO" ?>
                        <!--begin::Description-->
                        <span class="page-desc text-white fs-6 fw-bold pt-4">Sistema de Apoio Hospitalar</span>
                        <!--end::Description-->
                    </h1>
                    <!--end::Title-->
                </div>
